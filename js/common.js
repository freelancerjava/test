$(function () {
	...
	$('#profile-tabs ul.tabs li').click(function () {
		...
		$('#profile-tabs ul.tabs li').removeClass('current');
		$('#profile-tabs .tab-content').removeClass('current');

		$(this).addClass('current');
		$("#profile-tabs #" + tab_id).addClass('current');
	})
	...
	$("#lang").selectize({
		...
		render: {
			...
			item: function (item, escape) {
				return '<div class="option">' + escape(item.name) + '<i class="fa fa-angle-down" aria-hidden="true"><i/></div>';
			}
		}
	});
